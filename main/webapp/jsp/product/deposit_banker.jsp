	...
	<table border="1" id="middle">
		...
		<c:forEach var="product" items="${productList }">
			<tr>
				...
				<td id="button-${product.productID}"><input type="button"
					value="버튼" onclick="activateStatus('${product.productID}')">
				</td>
			</tr>
		</c:forEach>

	</table>
	<a href="${pageContext.request.contextPath }/productregistration.do">상품등록</a>
	<a href="">상품삭제</a>
</body>
</html>